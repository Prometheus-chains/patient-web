...
export async function deriveTagKeyNonce(healthRoot, recordAddr, seq, contentHash) {
    ...
    const okmBuf = await crypto.subtle.deriveBits({ name: "HKDF", hash: "SHA-256", salt: contentHash, info }, baseKey, bitLen);
